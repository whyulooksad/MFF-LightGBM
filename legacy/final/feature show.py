...
# ================= 可调参数 =================
WORK_DIR = "data/"                     # pcap 所在目录（按需修改为 "."）
FINAL_ML_TRAIN = "final_multiclass_features_train.csv"
FINAL_ML_TEST = "final_multiclass_features_test.csv"
FINAL_TEMP_TRAIN = "flow_metadata_temporal_train.csv"
FINAL_TEMP_TEST = "flow_metadata_temporal_test.csv"

...
输入：data/developer/datasets/prepared/pcap 下 *_sampled_*_train.pcap 和 *_sampled_*_test.pcap
输出：
...
from user_app.inference.pcap_reader import read_packets as fast_pcap_iter
